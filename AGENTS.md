...
This file is the quick-reference operating contract for sha2-kotlin. The longer
...
sha2-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`sha2`](https://crates.io/crates/sha2). Upstream Rust is the behavioral oracle while the
