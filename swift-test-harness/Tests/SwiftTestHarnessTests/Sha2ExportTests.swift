...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Sha2.swiftmodule/`
...
//      `import Sha2` above would fail at compile time.
//
//   2. The static archive `libSha2.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Sha2" }` and
//      `flattenPackage = "io.github.kotlinmania.sha2"` configuration in
...
final class Sha2ExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Sha2 swift module imported cleanly")
    }
}
