...
kotlin {
    ...
    swiftExport {
        moduleName = "Sha2"
        flattenPackage = "io.github.kotlinmania.sha2"
    }

    android {
        namespace = "io.github.kotlinmania.sha2"
        compileSdk = 34
        minSdk = 24
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.sha2.codeql
...
mavenPublishing {
    ...
    coordinates(group.toString(), "sha2-kotlin", version.toString())

    pom {
        name.set("sha2-kotlin")
        description.set("Kotlin Multiplatform port of RustCrypto/hashes - Pure Rust implementation of the SHA-2 hash function family including SHA-224, SHA-256, SHA-384, and SHA-512")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/sha2-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/sha2-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/sha2-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/sha2-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSha2XCFramework",
    "assembleSha2DebugXCFramework",
    "assembleSha2ReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSha2XCFramework",
    "assembleReleaseIosFatFrameworkForSha2XCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSha2XCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSha2XCFramework",
    "assembleDebugMacosFatFrameworkForSha2XCFramework",
    "assembleReleaseMacosFatFrameworkForSha2XCFramework",
    "assembleDebugTvosFatFrameworkForSha2XCFramework",
    "assembleReleaseTvosFatFrameworkForSha2XCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSha2XCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSha2XCFramework",
    "assembleDebugWatchosFatFrameworkForSha2XCFramework",
    "assembleReleaseWatchosFatFrameworkForSha2XCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSha2XCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSha2XCFramework",
